<!--
  DRAFT — generated from the current codebase as a fresh baseline to merge into your
  in-progress README. Safe to edit/move/delete; it does not touch README.md.
  Verify the install URL, screenshots, and tone before publishing.
-->
...
2. Paste the repo URL: `https://github.com/brasen56/openvault`
...
- **Run contradiction scan now** — sweep all memories for conflicts (see below).
