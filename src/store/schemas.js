...
export const MemorySchema = z.object({
    ...
    // Monotonic decay anchor — graph_message_count snapshot at creation time.
    // Survives chat compression (Inline Summary, deletes); see v4 migration for backfill.
...
export const EventSchema = z.object({
    ...
    is_transient: z.boolean().default(false),
