...
export const SENTIMENT_POSITIVE = new Set([
    // English
    'friend', 'friends', 'friendly', 'allied', 'ally', 'allies',
    'love', 'loves', 'loved', 'loving', 'affection', 'affectionate',
    'trust', 'trusts', 'trusted', 'trusting', 'trustworthy',
    'close', 'closer', 'closest', 'bonded', 'bond',
    'reconciled', 'reconciliation', 'reconnected', 'reunion',
    'peace', 'peaceful', 'harmonious', 'harmony',
    'forgave', 'forgiven', 'forgiveness', 'forgiving',
    'loyal', 'loyalty', 'devoted', 'devotion',
    'kind', 'kindness', 'caring', 'care', 'cares',
    'supportive', 'support', 'helped', 'helps', 'helping',
    'grateful', 'gratitude', 'appreciative', 'appreciation',
    'warm', 'warmer', 'warmth', 'gentle',
    'respect', 'respects', 'respected', 'respectful',
    'admire', 'admires', 'admiration',
    'protective', 'protects', 'protected', 'protection',
    'comfort', 'comforts', 'comforted', 'comforting',
    'apologized', 'apology', 'sorry',
    'made up', 'made peace', 'became friends', 'grew closer',
    'accepted', 'acceptance',
    // Russian (including inflected forms for regex matching)
    'друг', 'друзья', 'друзьями', 'другу', 'другом',
    'подруга', 'подруги', 'подругу', 'подругой',
    'дружба', 'дружеский', 'дружелюбный',
    'любовь', 'любит', 'любимый', 'любимая', 'любят',
    'доверие', 'доверяет', 'доверенный',
    'близкий', 'близко', 'сблизились',
    'мир', 'мирный', 'примирение', 'примирились', 'помирились',
    'прощение', 'простил', 'простила',
    'верный', 'верность', 'преданный',
    'добрый', 'доброта', 'забота', 'заботливый',
    'поддержка', 'поддерживает',
    'благодарный', 'благодарность',
    'теплый', 'тепло', 'нежный', 'нежность',
    'уважение', 'уважает',
    'защищает', 'защита',
    'извинился', 'извинилась', 'извинение',
]);
...
export const SENTIMENT_NEGATIVE = new Set([
    // English
    'enemy', 'enemies', 'hostile', 'hostility',
    'hate', 'hates', 'hated', 'hatred', 'hating',
    'distrust', 'distrusts', 'distrusted', 'distrustful',
    'betrayed', 'betrayal', 'betray', 'betrays',
    'angry', 'anger', 'furious', 'rage', 'enraged',
    'fought', 'fight', 'fighting', 'fights',
    'argued', 'argument', 'argue', 'argues', 'arguing',
    'conflict', 'conflicting', 'clashed', 'clash',
    'rival', 'rivals', 'rivalry', 'rivaling',
    'unfriendly', 'cold', 'colder', 'distant', 'distance',
    'rejected', 'rejection', 'reject', 'rejects',
    'resent', 'resents', 'resentment', 'resentful',
    'suspicious', 'suspicion', 'wary',
    'feud', 'feuding',
    'bitter', 'bitterness', 'grudge', 'grudges',
    'antagonistic', 'antagonism',
    'opposed', 'opposition', 'opposing',
    'dislike', 'dislikes', 'disliked',
    'estranged', 'alienated', 'alienation',
    'abandoned', 'abandonment', 'abandon',
    'threat', 'threatened', 'threatening', 'threatens',
    'broke up', 'fell out', 'turned against', 'became enemies',
    'violent', 'violence', 'attacked', 'attack',
    // Russian
    'враг', 'враги', 'враждебный', 'вражда',
    'ненависть', 'ненавидит', 'ненавижу',
    'недоверие', 'не доверяет', 'недоверчивый',
    'предал', 'предала', 'предательство',
    'злой', 'злость', 'злится', 'ярость', 'в гневе',
    'ссора', 'ссорился', 'ссорилась', 'поссорились',
    'конфликт', 'конфликтовал',
    'соперник', 'соперники', 'соперничество',
    'недружелюбный', 'холодный', 'отдаленный',
    'отверг', 'отвергла', 'отвержение',
    'обида', 'обиженный', 'обижена',
    'подозрение', 'подозрительный',
    'злопамятный', 'обида', 'неприязнь',
    'покинул', 'покинула', 'бросил', 'бросила',
    'угроза', 'угрожает',
