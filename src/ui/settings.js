...
function bindUIElements() {
    ...
    bindSetting('max_visible_messages', 'maxVisibleMessages');
...
export function updateUI() {
    ...
    $('#openvault_max_visible_messages').val(settings.maxVisibleMessages ?? 0);
    $('#openvault_max_visible_messages_value').text(settings.maxVisibleMessages ?? 0);
